...
CREATE TABLE IF NOT EXISTS `Teacher/Staff` (
	...
	`Tch-Mob No.`	VARCHAR(15) NOT NULL UNIQUE,
	`Tch-Designation`	VARCHAR(30) NOT NULL,
	`Tch Salary`	INTEGER NOT NULL,
	`Tch-Experience`	VARCHAR(50),
	`Tch-DOB`	NUMERIC NOT NULL,
	`Tch-Res Add`	VARCHAR(50) NOT NULL UNIQUE,
	`Matriculation`	VARCHAR(30) NOT NULL,
	`Graduation`	VARCHAR(30),
	`Post-Graduation`	VARCHAR(30),
	`Time-table`	VARCHAR(30) NOT NULL,
	`Tch-DOJ`	NUMERIC NOT NULL,
	`Tch-Email`	VARCHAR(30) NOT NULL UNIQUE,
	`SS-ID`	INTEGER NOT NULL UNIQUE,
	`Tch-Father/Spouse Name`	VARCHAR(30) NOT NULL,
	`Off-Id`	INTEGER NOT NULL,
	`Intermediate`	VARCHAR(30) NOT NULL,
...
ADD FOREIGN KEY (`Tch-ID`) REFERENCES `Teacher/Staff`(`Tch_ID`) ON DELETE RESTRICT;
...
CREATE TABLE IF NOT EXISTS `School Property` (
	...
	`Principal Chair`	NUMERIC NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `TextBooks` (
	`TxtBook-ID`	INTEGER NOT NULL UNIQUE AUTO_INCREMENT,
	`Stk-ID`	INTEGER NOT NULL,
	`Nsy-Sc`	INTEGER,
	`Nsy-M`	INTEGER,
	`Nsy-E`	INTEGER,
...
CREATE TABLE IF NOT EXISTS `All-Type of Uniforms` (
	`All-Type of Uniforms-ID`	INTEGER NOT NULL UNIQUE AUTO_INCREMENT,
	`Stk-ID`	INTEGER NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS `Boys-Uniforms` (
	`Boys-Unifrm-ID`	INTEGER NOT NULL UNIQUE AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `Girls-Uniforms` (
	`Grl-Unfrm-ID`	INTEGER NOT NULL UNIQUE,
	`All-Type of Uniforms-ID`	INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS `Others-uniform` (
	`othr-Unifm-ID`	INTEGER NOT NULL UNIQUE AUTO_INCREMENT,
	`All-Type of Uniforms-ID`	INTEGER NOT NULL,
	`White`	INTEGER,
	`Check`	INTEGER,
	`Blue`	INTEGER,
...
CREATE TABLE IF NOT EXISTS `Swtr` (
	`Swtr-ID`	INTEGER NOT NULL UNIQUE AUTO_INCREMENT,
	`All-Type of Uniforms-ID`	INTEGER NOT NULL,
	`S-Jrsy-22`	INTEGER,
	`S-Jrsy-24`	INTEGER,
	`S-Jrsy-26`	INTEGER,
...
CREATE TABLE IF NOT EXISTS `Student` (
	...
	`Std-Father-Phone`	NUMERIC,
	`Std-Mother-Name`	VARCHAR(30),
	`Std-Mother-CNIC`	NUMERIC,
	`Std-Mother-PhoneNo`	NUMERIC,
