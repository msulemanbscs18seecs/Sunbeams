...
CREATE TABLE IF NOT EXISTS `Teacher-OR-Staff` (
	...
	`Tch-Email`	VARCHAR(30) NOT NULL,
	`SS-ID`	INTEGER NOT NULL,
...
ADD FOREIGN KEY (`Tch-ID`) REFERENCES `Teacher-OR-Staff`(`Tch_ID`) ON DELETE RESTRICT;
